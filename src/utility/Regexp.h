...
#ifndef LIBRARIES_DT_REGULAR_EXPRESSION_H_
#define LIBRARIES_DT_REGULAR_EXPRESSION_H_
...
public:
  ...
  MatchState () : result (REGEXP_NOMATCH), src (0), src_len(0), src_end(0), MatchStart(0), MatchLength(0), level(0) {};  // constructor
...
#endif /* LIBRARIES_DT_REGULAR_EXPRESSION_H_ */
